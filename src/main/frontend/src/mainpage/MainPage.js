    ...
    return (
        <>
            ...
            <section class="mainpage-container">
                ...
                <div class="mainpage-restaurant">
                    <h4>정성가득 한식당 <span style={{color:"#f97316"}}>⭐ 4.8</span></h4>
                    <div class="mainpage-tags"><span>#복지카드 사용 가능</span><span>#한식</span><span>#1인 전용</span></div>
                ...
                <div class="mainpage-restaurant">
                    ...
                    <div class="mainpage-tags"><span>#일식</span><span>#캐주얼</span><span>#라멘</span></div>
                ...
                <div class="mainpage-restaurant">
                    ...
                    <div class="mainpage-tags"><span>#중식</span><span>#1인분 주문 가능</span><span>#매운맛 조절 가능</span></div>
                ...
                <div class="mainpage-restaurant">
                    ...
                    <div class="mainpage-tags"><span>#샐러드</span><span>#다이어트 음식</span><span>#복지카드 사용 가능</span></div>
            ...
            <section class="mainpage-services">
                <div class="mainpage-container mainpage-grid">
                    <div class="mainpage-service-card">
                        <h4>맛집 검색</h4>
                        <p>지역, 음식 종류, 가격대 등 다양한 필터로 나에게 맞는 혼밥 맛집을 찾아보세요.</p>
                        <button class="mainpage-btn-orange">검색하기</button>
                    </div>
                    <div class="mainpage-service-card">
                        <h4>지도로 보기</h4>
                        <p>내 주변의 혼밥인 추천 식당들을 지도에서 확인하고 방문해보세요.</p>
                        <button class="mainpage-btn-orange">지도 보기</button>
                    </div>
                    <div class="mainpage-service-card">
                        <h4>맛집 리스트</h4>
                        <p>다양한 테마별 인기 맛집 리스트를 확인하고 나만의 맛집을 경험해보세요.</p>
                        <button class="mainpage-btn-orange">리스트 보기</button>
                    </div>
                </div>
            </section>

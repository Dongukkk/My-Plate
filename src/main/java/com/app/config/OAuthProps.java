...
public class OAuthProps {
    ...
    public static final String GOOGLE_REDIRECT_URI  = "http://localhost:8080/api/oauth/google/callback";
    ...
    public static final String NAVER_REDIRECT_URI  = "http://localhost:8080/api/oauth/naver/callback";
    ...
    public static final String KAKAO_REDIRECT_URI  = "http://localhost:8080/api/oauth/kakao/callback";
